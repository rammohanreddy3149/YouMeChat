        ...
        homePage: function(req, res){
           ...
           //console.log("hi");
            async.parallel([
                ...
                res.render('home', {title: 'YouMeChat - Home', user:req.user, chunks: dataChunk, country: countrySort, data:res3, chat:res4});// chunks: dataChunk, country: countrySort, data:res3, chat:res4});
            });
        },
